...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['save'])) {
    ...
    $sql = "INSERT INTO fitness_goals (client_name, nic, start_date, start_weight, end_date, goal_weight) 
            VALUES ('$clientName', '$nic', '$startDate', '$startWeight', '$endDate', '$goalWeight')";

    if (mysqli_query($conn, $sql)) {
        echo "<script>alert('Goal successfully saved!'); window.location.href = 'emily-set-goal.php';</script>";
    } else {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update'])) {
    ...
    $sql = "UPDATE fitness_goals SET 
            client_name='$clientName', nic='$nic', start_date='$startDate', start_weight='$startWeight', 
            end_date='$endDate', goal_weight='$goalWeight' 
            WHERE id='$id'";

    if (mysqli_query($conn, $sql)) {
        echo "<script>alert('Goal successfully updated!'); window.location.href = 'emily-set-goal.php';</script>";
    } else {
        echo "Error: " . $sql . "<br>" . mysqli_error($conn);
    }
}
...
if (isset($_GET['delete'])) {
    ...
    $sql = "DELETE FROM fitness_goals WHERE id='$id'";

    if (mysqli_query($conn, $sql)) {
        echo "<script>alert('Goal successfully deleted!'); window.location.href = 'emily-set-goal.php';</script>";
    } else {
        echo "Error: " . $sql . "<br>" . mysqli_error($conn);
    }
}
...
$result = mysqli_query($conn, "SELECT * FROM fitness_goals");
...
<div class="container">
    ...
    <form method="POST" action="emily-set-goal.php">

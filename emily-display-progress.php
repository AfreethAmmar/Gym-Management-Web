...
<body>
    <div class="container">
        <a href="emily-progress-tracking.php" class="button">Back to Progress Tracking</a>
        <h1>See Progress</h1>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $goalQuery = "SELECT goal_weight FROM fitness_goals WHERE client_name = '$clientName' AND nic = '$nic'";
            $progressQuery = "SELECT weight FROM client_progress WHERE client_name = '$clientName' AND nic = '$nic' ORDER BY month DESC LIMIT 1";

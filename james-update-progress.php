...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['update'])) {
        ...
        $sql = "UPDATE james_client_progress SET client_name='$clientName', nic='$nic', month='$month', weight='$weight' WHERE id='$id'";

        if (mysqli_query($conn, $sql)) {
            echo "<script>alert('Progress successfully updated!'); window.location.href = 'james-update-progress.php';</script>";
        } else {
        ...
        $sql = "DELETE FROM james_client_progress WHERE id='$id'";

        if (mysqli_query($conn, $sql)) {
            echo "<script>alert('Progress successfully deleted!'); window.location.href = 'james-update-progress.php';</script>";
        } else {
            echo "Error: " . $sql . "<br>" . mysqli_error($conn);
        }
    } else {
        ...
        $sql = "INSERT INTO james_client_progress (client_name, nic, month, weight) 
                VALUES ('$clientName', '$nic', '$month', '$weight')";

        if (mysqli_query($conn, $sql)) {
            echo "<script>alert('Progress successfully saved!'); window.location.href = 'james-update-progress.php';</script>";
        } else {
            echo "Error: " . $sql . "<br>" . mysqli_error($conn);
        }
    }
...
$sql = "SELECT * FROM james_client_progress";
...
<a href="james-Progress-tracking-page.php" class="button">Back to Dashboard</a>
    <div class="container">
        ...
        <form action="james-update-progress.php" method="POST">

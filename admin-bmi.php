...
<body>
    <div class="container">
        ...
        <form id="bmiForm" action="admin-bmi.php" method="POST">
            ...
            <button type="button"><a href="admin.php" style="color: white; text-decoration: none;">Back</a></button>
        </form>
...
<div class="modal" id="recommendationModal" style="display: flex;">
    <div class="modal-content">
        ...
        <form action="admin-bmi.php" method="POST">

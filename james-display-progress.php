...
<body>
    <div class="container">
        <a href="james-Progress-tracking-page.php" class="button">Back to Progress Tracking</a>
        <h1>See Progress</h1>
        
        <div class="form-container">
            <form action="james-display-progress.php" method="POST">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $goalQuery = "SELECT goal_weight FROM james_fitness_goals WHERE client_name = '$clientName' AND nic = '$nic'";
            $progressQuery = "SELECT weight FROM james_client_progress WHERE client_name = '$clientName' AND nic = '$nic' ORDER BY month DESC LIMIT 1";

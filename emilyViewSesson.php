...
if (isset($_POST['delete'])) {
    $id = $_POST['id'];
    $delete_sql = "DELETE FROM bmi_group_fitness WHERE id = ?";
...
if (isset($_POST['edit'])) {
    ...
    $edit_sql = "UPDATE bmi_group_fitness SET name=?, age=?, gender=?, height=?, weight=?, bmi=?, address=?, phone=?, session_date=?, recommendations=? WHERE id=?";
...
$sql = "SELECT id, name, age, gender, height, weight, bmi, address, phone, session_date, recommendations FROM bmi_group_fitness";
...
<body>
    <div class="container">
        ...
        <a href="jamesStaffdashboard.php" class="back-btn">Back to Home</a>
        <!-- Edit Modal -->

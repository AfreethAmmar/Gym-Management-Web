...
<body>
    <div class="container">
        ...
        <form id="bmiForm" action="staff-bmi.php" method="POST">
            ...
            <button type="button"><a href="staff_main_dashboard.php" style="color: white; text-decoration: none;">Back</a></button>
        </form>
...
<div class="modal" id="recommendationModal" style="display: flex;">
    <div class="modal-content">
        ...
        <form action="staff-bmi.php" method="POST">
